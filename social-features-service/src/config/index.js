...
export function getConfig() {
  ...
  const services = {
    ...
    referral: process.env.REFERRAL_SERVICE_URL || 'http://referral-service:4006',
    notification: process.env.NOTIFICATION_SERVICE_URL || 'http://notification-service:4004',
    merchant: process.env.MERCHANT_ONBOARDING_SERVICE_URL || 'http://merchant-onboarding-service:4003'
  };
